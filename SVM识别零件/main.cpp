...
void trainAndTest()
{
  ...
  // Get the nut images
  readFolderAndExtractFeatures("/home/xuxuxu/b/cmake/SVM识别零件/data/nut/tuerca_%04d.pgm", 0, num_for_test, trainingData, responsesData, testData, testResponsesData);
  // Get and process the ring images
  readFolderAndExtractFeatures("/home/xuxuxu/b/cmake/SVM识别零件/data/ring/arandela_%04d.pgm", 1, num_for_test, trainingData, responsesData, testData, testResponsesData);
  // get and process the screw images
  readFolderAndExtractFeatures("/home/xuxuxu/b/cmake/SVM识别零件/data/screw/tornillo_%04d.pgm", 2, num_for_test, trainingData, responsesData, testData, testResponsesData);
...
FileStorage fs("1.yml",FileStorage::WRITE);
fs<<"trainningDataMat"<<trainingDataMat;
...
int main( int argc, const char** argv )
{
  ...
  String img_file= "/home/xuxuxu/b/cmake/SVM识别零件/data/test.pgm";
  String light_pattern_file= "/home/xuxuxu/b/cmake/SVM识别零件/data/pattern.pgm";
  ...
  // Load image to process
  light_pattern= imread(light_pattern_file);
  ...
  for(int i=0; i< features.size(); i++){
	...
	//Mat trainingDataMat=(Mat_<float>(1, 2)<<features[i][0],features[i][1]);
